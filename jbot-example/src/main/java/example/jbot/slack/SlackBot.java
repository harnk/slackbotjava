...
public class SlackBot extends Bot {
    ...
    public void onReceiveDM(WebSocketSession session, Event event) {
        if (event.getText().contains("status")) {
            reply(session, event, "I am working on delivering a status update to you now.");
        } else {
            reply(session, event, "Hi, I am " + slackService.getCurrentUser().getName()+". Why did you say " + event.getText() + "?");
        }
    }
